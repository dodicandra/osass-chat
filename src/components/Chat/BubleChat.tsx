...
const BubleChat: React.FC<BubleChatProps> = ({sender, content, imgLeft, time}) => {
  return !sender ? (
...
BubleChat.defaultProps = {
  sender: false,
  content: 'haloo selamat menikmati chattingmu.. saya disini akan menemanimu sampai kamu nagantuk'
};
